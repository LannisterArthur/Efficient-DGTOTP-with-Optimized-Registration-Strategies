...
#define MYOTS_FULL_HEIGHT 2
#define MYOTS_D 1
#define MYOTS_TREE_HEIGHT (MYOTS_FULL_HEIGHT / MYOTS_D)
...
/* Resulting SPX sizes. */
#define SPX_BYTES ((SPX_N + SPX_FORS_BYTES + MYOTS_D * SPX_WOTS_BYTES +     \
                    MYOTS_FULL_HEIGHT * SPX_N + (MYOTS_D * COUNTER_SIZE)) + \
                   COUNTER_SIZE)
#define ALL_BYTES ((SPX_N + SPX_FORS_BYTES + SPX_D * SPX_WOTS_BYTES +     \
                    SPX_FULL_HEIGHT * SPX_N + (SPX_D * COUNTER_SIZE)) +   \
                   COUNTER_SIZE +                                         \
                   MYOTS_D * SPX_WOTS_BYTES +                             \
                   MYOTS_FULL_HEIGHT * SPX_N + (MYOTS_D * COUNTER_SIZE) + \
                   COUNTER_SIZE)
